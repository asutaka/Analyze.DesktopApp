...
{
    public partial class frmChartTest : XtraForm
    {
        private static frmChartTest _instance = null;
        private readonly string _fileName = "coin_follow.json";
        private CoinFollowModel _coinFollowModel;
        private frmChartTest()
        {
            InitializeComponent();
            //InitData();
            //tmp();
        ...
        public static frmChartTest Instance()
        {
            _instance = (_instance == null || _instance.IsDisposed) ? new frmChartTest() : _instance;
            return _instance;
        }
